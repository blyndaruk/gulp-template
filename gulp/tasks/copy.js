...
const build = gulp => gulp.series('copy:img', 'copy:fonts', 'copy:docs', 'copy:data');
const watch = gulp => () => gulp.watch(config.src.img + '/*', gulp.parallel('copy:img', 'copy:fonts', 'copy:docs', 'copy:data'));
